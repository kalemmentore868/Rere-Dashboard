...
import TaxPending from "./pages/TaxPending";
...
import HomeTax from "./components/Dashboard/HomeTax";
...
const Markup = () => {
  const allroutes = [
    ...
    { url: "dashboard-tax", component: <HomeTax /> },
    ...
    { url: "tax-pending", component: <TaxPending /> },
